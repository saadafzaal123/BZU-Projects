        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                        <li><a href="<?php echo e(URL::route('getShops', array('id' => $m->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($m->name); ?> </a></li>
                    </ul>
    ...
    <div id="services" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="/One_Market/public/market_images/<?php echo e($m->image1); ?>" height = "400" width = "400" alt="<?php echo e($m->image1); ?>">
                <h3><?php echo e($m->name); ?></h3>
                <br>
                <a href = "<?php echo e(URL::route('getMarketDetails', array('id' => $m->id))); ?>"><button type="button" class="btn btn-primary btn-md">Details</button></a>
               <a href = "<?php echo e(URL::route('getShops', array('id' => $m->id))); ?>"><button type="button" class="btn btn-primary btn-md">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       <?php foreach($product as $p): ?>
                                           ...
                                           <?php if($c->p_id == $p->id): ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => $getCity->id , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))); ?>" method = "POST">
