        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <?php foreach($city as $c): ?>
                    ...
                    <?php if($c->id == $city_details->id): ?>

                    <li class = "active">
                        <a href="<?php echo e(URL::route('getCityDetails', array('id' => $c->id))); ?>" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($c->name); ?> </a>
                    </li>

                    <?php elseif($c->id != $city_details->id): ?>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                <h2 style = "margin-bottom: 20px;"><?php echo e($city_details->name); ?></h2>
                <img src="/One_Market/public/city_images/<?php echo e($city_details->image1); ?>" height = "350" width = "350" alt="<?php echo e($city_details->image1); ?>">
                <img src="/One_Market/public/city_images/<?php echo e($city_details->image2); ?>" height = "350" width = "350" alt="<?php echo e($city_details->image1); ?>">
                <img src="/One_Market/public/city_images/<?php echo e($city_details->image3); ?>" height = "350" width = "350" alt="<?php echo e($city_details->image1); ?>">
                <br>
                <br>
                <h4><?php echo e($city_details->description); ?></h4>
                <br>
                                       ...
                                       <?php foreach($product as $p): ?>
                                           ...
                                           <?php if($c->p_id == $p->id): ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => $city_details->id , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))); ?>" method = "POST">
