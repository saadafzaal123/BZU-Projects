       ...
       <header>               
        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    <form action = "<?php echo e(route('searchShop' , array('m_id'=>$getMarket->id))); ?>" method = "POST">
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
                        ...
                        <li class="active"><a href="/One_Market/public/Customer_Login"><span class="btnicon icon-cloud-download"></span>Customer Log In</a></li>
						<li class="active"><a href="/One_Market/public/Vendor_Login"><span class="btnicon icon-cloud-download"></span>Vender Log In</a></li>
                    </ul>
                    ...
                    <?php foreach($search as $s): ?>
                        ...
                        <?php if($s->market_id == $m->id): ?>
                            ...
                            <li>
                                ...
                                <a href="<?php echo e(URL::route('getShops', array('id' => $m->id))); ?>" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($m->name); ?> </a>

                                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                                        <li class="active"><a href="<?php echo e(URL::route('getItems', array('id' => $s->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($s->shop_name); ?> </a></li>
                                    </ul>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="/One_Market/public/shop_images/<?php echo e($s->shop_image); ?>" height = "400" width = "400" alt="<?php echo e($s->shop_image); ?>">
                <h3><?php echo e($s->shop_name); ?></h3><br>
                <a href = "<?php echo e(URL::route('getItems', array('id' => $s->id))); ?>"><button type="button" class="btn btn-primary btn-md" style = "margin-left:15px;">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
               ...
               <div class="row">
                   ...
                   <div  class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                       ...
                       <div class="container">
                                       ...
                                       <?php foreach($product as $p): ?>
                                           ...
                                           <?php if($c->p_id == $p->id): ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => $getMarket->id , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))); ?>" method = "POST">
                           ...
                           <div style = "font-size: 22px;" class="col-md-6 col-lg-9 wow fadeInUp" data-wow-duration="3s">
                               <a href = "/One_Market/public/index"><button style = "width: 20%;" type="button" class="btn btn-primary btn-md">Continue Shopping</button></a>
