    ...
    <div id="portfolio" class="container" style = "width:100%; margin-top:-20px; background:#e3e3e3;">
		...
		<div class="module form-module" style = "margin-bottom:50px;">
            ...
            <div class="form">
                ...
                <form action = "<?php echo e(route('insertCustomer')); ?>" method = "post" enctype = "multipart/form-data">
                    ...
                    <?php if($errors->has('customerImage')): ?>
                        <span class="help-block" style = "color: red;">
                        <strong><?php echo e($errors->first('customerImage')); ?></strong>
                    </span>
