   ...
   =========================== -->
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
					...
					<li><a href="#services"><span class="btnicon icon-user"></span>Cities</a></li>
                        ...
                        <li><a href="#portfolio"><span class="btnicon icon-rocket"></span>Trending</a></li>
                        <li><a href="#testimonials"><span class="btnicon icon-bubble"></span>Categories</a></li>
                        
                        <!--don't forget to replace my email address below with yours-->
                        <li class="active"><a href=""><span class="btnicon icon-cloud-download"></span>Customer Log In</a></li>
						<li class="active"><a href="VenderLogin.html"><span class="btnicon icon-cloud-download"></span>Vender Log In</a></li>
                    </ul>
	  ...
	  <!-- ==============================
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    <a href="#" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> Lahore</a>
                </li>
                <li>
                    <a href="#"class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-cloud-download fa-stack-1x "></i></span>Karachi</a>
                 
                </li>
                <li>
                    <a href="#"class="shop"> <span class="fa-stack fa-lg pull-left"><i class="fa fa-cart-plus fa-stack-1x "></i></span>Islamabad</a>
                ...
                <li>
                    <a href="#portfolio"><span class="fa-stack fa-lg pull-left"><i class="fa fa-server fa-stack-1x "></i></span>Trending</a>
                </li>
				<li>
                    <a href="#testimonials"><span class="fa-stack fa-lg pull-left"><i class="fa fa-server fa-stack-1x "></i></span>Categories</a>
                </li>
            </ul>
         </div>
    ...
    <div id="services" class="container">
        ...
        <div class="row">
               <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                   <img src="city_images/23274.jpg" height = "400" width = "400" alt="">
                   <h4>Islamabad City</h4>
				   <button style = "margin-bottom:10px; padding: 5px; background:#e3e3e3;">GoInside</button>
                ...
                <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                    <img src="city_images/88007.jpg" height = "400" width = "400" alt="">
                   <h4>Lahore City</h4>
				   <button style = "margin-bottom:10px; padding: 5px; background:#e3e3e3;">GoInside</button>
                   <p>Grinder affogato, dark, sweet carajillo, flavour seasonal aroma single origin cream. Percolator. Eligendi impedit dolores nulla.</p>
                </div> <!-- ITEM END -->
                ...
                <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                   <img src="city_images/52492.jpg" height = "400" width = "400" alt="">
                   <h4>Karachi City</h4>
				   <button style = "margin-bottom:10px; padding: 5px; background:#e3e3e3;">GoInside</button>
                   <p>Grinder affogato, dark, sweet carajillo, flavour seasonal aroma single origin cream. Percolator. Eligendi impedit dolores nulla.</p>
                </div> <!-- ITEM END -->
    ...
    <div id="testimonials" class="container">
        <div class="sectionhead wow bounceInUp" data-wow-duration="2s">
           ...
           <h3>This is whats I love to listen</h3>
        ...
        <div class="row" style = "margin-left: 40px;">
            ...
            <div class="col-md-9 wow bounceIn" data-wow-duration="3s">
				...
				<div class="quote">
                    ...
                    <h5>Bill S Kenney</h5><p>Art Director at Focus Lab LLC.</p>
                </div>
