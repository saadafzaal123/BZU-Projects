       ...
       <header>               
        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    <form action = "<?php echo e(route('searchProduct' , array('v_id'=>$shop->id))); ?>" method = "POST">
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
                        ...
                        <li class="active"><a href="Customer_Login"><span class="btnicon icon-cloud-download"></span><?php if(Session::get('c_email') != null): ?> <?php echo e($customer->username); ?> <?php else: ?> Customer Log In <?php endif; ?> </a></li>
	  ...
	  <!-- ==============================
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    <a href="<?php echo e(URL::route('getItems', array('id' => $shop->id))); ?>" id="" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-dashboard fa-stack-1x "></i></span><?php echo e($shop->shop_name); ?></a>
                </li>
                            ...
                            <li class="active">
                                ...
                                <?php foreach($cat as $c): ?>
                                    ...
                                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                                        <li style = "font-size: 18px;"><a href="<?php echo e(URL::route('getCategory', array('c_id' => $c->id , 'v_id' => $shop->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($c->name); ?> </a></li>
                                    </ul>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                            <li style = "font-size: 18px;"><a href="<?php echo e(URL::route('getBrand', array('b_id' => $b->id , 'v_id' => $shop->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($b->name); ?> </a></li>
                        </ul>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                ...
                <img src="/One_Market/public/product_images/<?php echo e($p->image1); ?>" height = "350" width = "350" alt="<?php echo e($p->image1); ?>">
                <h3><?php echo e("Price: $ ".$p->price); ?></h3>
                <br>
                <a href = "<?php echo e(URL::route('getProductDetails', array('id' => $p->id , 'v_id' => $p->vendor_id))); ?>"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "<?php echo e(URL::route('addToCart', array('p_id' => $p->id , 'price' => $p->price , 'shop_id' => $shop->id , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0))); ?>"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                ...
                                <?php foreach($cart as $c): ?>
                                  ...
                                  <?php foreach($product as $p): ?>
                                   ...
                                   <tr>
                                       ...
                                       <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => $shop->id , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))); ?>" method = "POST">
