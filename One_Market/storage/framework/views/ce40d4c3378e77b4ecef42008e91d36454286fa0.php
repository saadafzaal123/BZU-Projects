        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    ...
                    <form action = "<?php echo e(route('searchMarket' , array('c_id'=>$getCity->id))); ?>" method = "POST">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    ...
                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                        <li class = "active"><a href="<?php echo e(URL::route('getShops', array('id' => $s->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($s->name); ?> </a></li>
                    </ul>

                </li>

                           <?php elseif($s->city_id != $c->id): ?>
    ...
    <div id="services" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="/One_Market/public/market_images/<?php echo e($s->image1); ?>" height = "400" width = "400" alt="<?php echo e($s->image1); ?>">
                <h3><?php echo e($s->name); ?></h3>
                <br>
                <a href = "<?php echo e(URL::route('getMarketDetails', array('id' => $s->id))); ?>"><button type="button" class="btn btn-primary btn-md">Details</button></a>
               <a href = "<?php echo e(URL::route('getShops', array('id' => $s->id))); ?>"><button type="button" class="btn btn-primary btn-md">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
