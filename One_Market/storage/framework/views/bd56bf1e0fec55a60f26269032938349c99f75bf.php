<?php $__env->startSection('title', 'Vendor Search Brand'); ?>
...
<?php $__env->startSection('navbar'); ?>
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
            ...
            <li><a href="#ViewAP"><span class="btnicon icon-user"></span>View Search Brands</a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="ViewAP" class="container">
        ...
        <div class="sectionhead  row wow fadeInUp">
            <img data-wow-duration="4s" src="img/brand2.jpg" height = "120px" alt="Search Logo"/>
            <h3>View Search Brands</h3>
            <hr class="separetor">
        </div>
