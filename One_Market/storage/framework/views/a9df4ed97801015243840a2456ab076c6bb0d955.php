<?php $__env->startSection('title', 'Vendor Search Customer'); ?>
...
<?php $__env->startSection('navbar'); ?>
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
            ...
            <li><a href="#ViewAP"><span class="btnicon icon-user"></span>View Search Customers</a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="ViewAP" class="container">
        ...
        <div class="sectionhead  row wow fadeInUp">
            <img data-wow-duration="4s" src="img/Customer.jpg" height = "120px" alt="Search Logo"/>
            <h3>View Search Customers</h3>
            <hr class="separetor">
        </div>
        ...
        <div id = "th">
            <table  width = "1000" align = "center" border = "1" bgcolor="black" style = "color:white; background:black; font-size:16px; margin-bottom:70px;">
                ...
                <tr>
                    <td colspan = "6" align = "center"><h2>Search Customers Here!</h2></td>
                </tr>
