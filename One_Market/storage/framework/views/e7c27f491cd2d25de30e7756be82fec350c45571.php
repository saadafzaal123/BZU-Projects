    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                ...
                <img src="/One_Market/public/product_images/<?php echo e($g->image1); ?>" height = "350" width = "350" alt="<?php echo e($g->image1); ?>">
                <h3><?php echo e("Price: $ ".$g->price); ?></h3>
                <br>
                <a href = "<?php echo e(URL::route('getProductDetails', array('id' => $g->id , 'v_id' => $g->vendor_id))); ?>"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "<?php echo e(URL::route('addToCart', array('p_id' => $g->id , 'price' => $g->price , 'shop_id' => 0 , 'category_id' => $cats->id , 'vendor_id' => $shop->id , 'brand_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0))); ?>"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       <?php foreach($product as $p): ?>
                                           ...
                                           <?php if($c->p_id == $p->id): ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => $cats->id , 'vendor_id' => $shop->id , 'brand_id' => 0))); ?>" method = "POST">
