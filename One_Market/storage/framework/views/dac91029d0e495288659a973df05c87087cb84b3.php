    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                ...
                <img src="/One_Market/public/product_images/<?php echo e($s->image1); ?>" height = "350" width = "350" alt="<?php echo e($s->image1); ?>">
                <h3><?php echo e("Price: $ ".$s->price); ?></h3>
                <a href = "<?php echo e(URL::route('getProductDetails', array('id' => $s->id , 'v_id' => $s->vendor_id))); ?>"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "<?php echo e(URL::route('addToCart', array('p_id' => $s->id , 'price' => $s->price , 'shop_id' => $shop->id , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0))); ?>"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
