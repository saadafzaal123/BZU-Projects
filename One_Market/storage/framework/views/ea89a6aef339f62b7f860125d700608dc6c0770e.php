    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                ...
                <a href = "<?php echo e(URL::route('addToCart', array('p_id' => $p->id , 'price' => $p->price , 'shop_id' => 0 , 'category_id' => 0 , 'vendor_id' => $shop->id , 'brand_id' => $brandss->id , 'product_details_id' => 0 , 'shop_details_id' => 0))); ?>"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       <?php foreach($product as $p): ?>
                                           ...
                                           <?php if($c->p_id == $p->id): ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => $shop->id , 'brand_id' => $brandss->id))); ?>" method = "POST">
