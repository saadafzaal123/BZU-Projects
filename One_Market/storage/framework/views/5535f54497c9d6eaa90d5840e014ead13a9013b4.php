       ...
       <header>               
        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    <form action = "<?php echo e(route('searchProduct' ,  array('v_id'=>$shop_details->id))); ?>" method = "POST">
	  ...
	  <!-- ==============================
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    <a href="<?php echo e(URL::route('getItems', array('id' => $shop_details->id))); ?>" id="" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-dashboard fa-stack-1x "></i></span><?php echo e($shop_details->shop_name); ?></a>
                </li>
                ...
                <li class="active">
                    ...
                    <?php foreach($cat as $c): ?>
                        ...
                        <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                            <li style = "font-size: 18px;"><a href="<?php echo e(URL::route('getCategory', array('c_id' => $c->id , 'v_id' => $shop_details->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($c->name); ?> </a></li>
                        </ul>
                ...
                <li class="active">
                    ...
                    <?php foreach($brand as $b): ?>
                        ...
                        <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                            <li style = "font-size: 18px;"><a href="<?php echo e(URL::route('getBrand', array('b_id' => $b->id , 'v_id' => $shop_details->id))); ?>"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($b->name); ?> </a></li>
                        </ul>
                ...
                <?php foreach($city as $c): ?>
                    ...
                    <li>
                        ...
                        <a href="<?php echo e(URL::route('getMarkets', array('id' => $c->id))); ?>" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> <?php echo e($c->name); ?> </a>
                    </li>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                <h2 style = "margin-bottom: 20px;"><?php echo e($product_details->name); ?></h2>
                <img src="/One_Market/public/product_images/<?php echo e($product_details->image1); ?>" height = "350" width = "350" alt="<?php echo e($product_details->image1); ?>">
                <img src="/One_Market/public/product_images/<?php echo e($product_details->image2); ?>" height = "350" width = "350" alt="<?php echo e($product_details->image1); ?>">
                <img src="/One_Market/public/product_images/<?php echo e($product_details->image3); ?>" height = "350" width = "350" alt="<?php echo e($product_details->image1); ?>">
                <h3><?php echo e("Price: $ ".$product_details->price); ?></h3>
                <br>
                <h4><?php echo e($product_details->description); ?></h4>
                <br>
                <a href = "<?php echo e(URL::route('getItems', array('id' => $shop_details->id))); ?>"><button type="button" class="btn btn-primary btn-md" style = "width: auto; float: start; margin-right: 40px;">Go Back</button></a>
                <a href = "<?php echo e(URL::route('addToCart', array('p_id' => $product_details->id , 'price' => $product_details->price , 'shop_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0 , 'product_details_id' => $product_details->id , 'shop_details_id' => $shop_details->id))); ?>"><button type="button" class="btn btn-primary btn-md" style = "width: auto; float: end; margin-left: 40px;">Add to Cart</button></a>
            </div> <!-- ITEM END -->
                       ...
                       <div class="container">
                                       ...
                                       <?php foreach($product as $p): ?>
                                           ...
                                           <?php if($c->p_id == $p->id): ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => $product_details->id , 'shop_details_id' => $shop_details->id , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))); ?>" method = "POST">
                           ...
                           <div style = "font-size: 22px;" class="col-md-6 col-lg-9 wow fadeInUp" data-wow-duration="3s">
                               ...
                               <?php if(Session::get('c_email') != null): ?>
                                   ...
                                   <a href = "<?php echo e(URL::route('customerCheckOut' , array('id' => $customer->id))); ?>"><button style = "width: 15%; margin-right: -60px; float: right;" type="button" class="btn btn-primary btn-md">Checkout</button></a>

                               <?php else: ?>

                                   <a href = "<?php echo e(URL::route('Customer_Login')); ?>"><button style = "width: 15%; margin-right: -60px; float: right;" type="button" class="btn btn-primary btn-md">Checkout</button></a>
