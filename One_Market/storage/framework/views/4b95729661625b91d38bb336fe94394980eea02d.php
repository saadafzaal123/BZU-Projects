...
<!--<<<<<<< HEAD-->
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
	            <form action = "<?php echo e(route('searchCity')); ?>" method = "POST">
<!--=======
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
					...
					<li><a href="#services"><span class="btnicon icon-user"></span>Cities</a></li>
						...
						<li class="active"><a href="Vendor_Login"><span class="btnicon icon-cloud-download"></span><?php if(Session::get('email') != null): ?> <?php echo e($vendor->username); ?> <?php else: ?> Vendor Log In <?php endif; ?></a></li>
                    </ul>
    ...
    <div id="services" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="city_images/<?php echo e($c->image1); ?>" height = "400" width = "400" alt="">
                <h3><?php echo e($c->name." City"); ?></h3>
                <br>
                <a href = "<?php echo e(URL::route('getCityDetails', array('id' => $c->id))); ?>"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "<?php echo e(URL::route('getMarkets', array('id' => $c->id))); ?>"><button type="button" class="btn btn-primary btn-md">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                           ...
                                           <?php foreach($product as $p): ?>
                                               ...
                                               <?php if($c->p_id == $p->id): ?>
                                                   ...
                                                   <tr>
                                                       ...
                                                       <form action = "<?php echo e(route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))); ?>" method = "POST">
