    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <h3>{{$s->name}}</h3>
                <img src="/One_Market/public/product_images/{{$s->image1}}" height = "350" width = "350" alt="{{$s->image1}}">
                <h3>{{"Price: $ ".$s->price}}</h3>
                <a href = "{{ URL::route('getProductDetails', array('id' => $s->id , 'v_id' => $s->vendor_id)) }}"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "{{ URL::route('addToCart', array('p_id' => $s->id , 'price' => $s->price , 'shop_id' => $shop->id , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0)) }}"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => $shop->id , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))}}" method = "POST">
