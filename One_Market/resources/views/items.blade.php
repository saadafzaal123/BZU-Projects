               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
                        ...
                        <li class="active"><a href="Customer_Login"><span class="btnicon icon-cloud-download"></span>@if (Session::get('c_email') != null) {{$customer->username}} @else Customer Log In @endif </a></li>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                ...
                <a href = "{{ URL::route('addToCart', array('p_id' => $p->id , 'price' => $p->price , 'shop_id' => $shop->id , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0)) }}"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
