               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
					    ...
					    <li><a href="#services"><span class="btnicon icon-user"></span>City Details</a></li>
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                @foreach($city as $c)
                    ...
                    @if($c->id == $city_details->id)

                    <li class = "active">
                        <a href="{{ URL::route('getCityDetails', array('id' => $c->id)) }}" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$c->name}} </a>
                    </li>

                    @elseif($c->id != $city_details->id)
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                <h2 style = "margin-bottom: 20px;">{{$city_details->name}}</h2>
                <img src="/One_Market/public/city_images/{{$city_details->image1}}" height = "350" width = "350" alt="{{$city_details->image1}}">
                <img src="/One_Market/public/city_images/{{$city_details->image2}}" height = "350" width = "350" alt="{{$city_details->image1}}">
                <img src="/One_Market/public/city_images/{{$city_details->image3}}" height = "350" width = "350" alt="{{$city_details->image1}}">
                <br>
                <br>
                <h4>{{$city_details->description}}</h4>
                <br>
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => $city_details->id , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))}}" method = "POST">
