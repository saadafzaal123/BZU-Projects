...
@section('navbar')
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
            ...
            <li><a href="{{ URL::route('VendorLogOut')}}"><span class="btnicon icon-cloud-download"></span>Vender LogOut</a></li>
        </ul>    
    </div><!--.nav-collapse -->
...
@section('content')
    ...
    <div id="services" class="container">
        ...
        <div class="sectionhead  row wow fadeInUp">
			...
			<form action="{{route('insertRent')}}" method="post" style = "margin-top:50px;">  <!--https://www.sandbox.paypal.com/cgi-bin/webscr-->
