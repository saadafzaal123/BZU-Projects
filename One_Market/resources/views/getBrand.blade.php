   ...
   =========================== -->
       ...
       <header>               
        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    <form action = "{{route('searchProduct' , array('v_id'=>$shop->id))}}" method = "POST">
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
					    ...
					    <li><a href="#services"><span class="btnicon icon-user"></span>Products</a></li>
	  ...
	  <!-- ==============================
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    <a href="{{URL::route('getItems', array('id' => $shop->id))}}" id="" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-dashboard fa-stack-1x "></i></span>{{$shop->shop_name}}</a>
                </li>
                            ...
                            <li class="active">
                                ...
                                @foreach($cat as $c)
                                    ...
                                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                                        <li style = "font-size: 18px;"><a href="{{URL::route('getCategory', array('c_id' => $c->id , 'v_id' => $shop->id))}}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$c->name}} </a></li>
                                    </ul>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                            <li style = "font-size: 18px;"><a href="{{URL::route('getBrand', array('b_id' => $b->id , 'v_id' => $shop->id))}}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$b->name}} </a></li>
                        </ul>
    ...
    <div id="services" class="container">
        ...
        <div class="sectionhead  row wow fadeInUp">
            <img data-wow-duration="4s" src="/One_Market/public/img/select.png" height = "150px" alt="Search Logo"/>
            <h3>Select Products Here</h3>
            <hr class="separetor">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <h3>{{$p->name}}</h3>
                <img src="/One_Market/public/product_images/{{$p->image1}}" height = "350" width = "350" alt="{{$p->image1}}">
                <h3>{{"Price: $ ".$p->price}}</h3>
                <br>
                <a href = "{{ URL::route('getProductDetails', array('id' => $p->id , 'v_id' => $p->vendor_id)) }}"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "{{ URL::route('addToCart', array('p_id' => $p->id , 'price' => $p->price , 'shop_id' => 0 , 'category_id' => 0 , 'vendor_id' => $shop->id , 'brand_id' => $brandss->id , 'product_details_id' => 0 , 'shop_details_id' => 0)) }}"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => $shop->id , 'brand_id' => $brandss->id))}}" method = "POST">
