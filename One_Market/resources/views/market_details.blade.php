        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                @foreach($market as $m)
                    ...
                    @if($m->id == $market_details->id)

                    <li class = "active">
                        <a href=" {{ URL::route('getMarketDetails', array('id' => $m->id )) }} " class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$m->name}} </a>
                    </li>

                    @elseif($m->id != $market_details->id)
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                <h2 style = "margin-bottom: 20px;">{{$market_details->name}}</h2>
                <img src="/One_Market/public/market_images/{{$market_details->image1}}" height = "350" width = "350" alt="{{$market_details->image1}}">
                <img src="/One_Market/public/market_images/{{$market_details->image2}}" height = "350" width = "350" alt="{{$market_details->image1}}">
                <img src="/One_Market/public/market_images/{{$market_details->image3}}" height = "350" width = "350" alt="{{$market_details->image1}}">
                <h3>{{"Area: ".$market_details->area}}</h3>
                <br>
                <h4>{{$market_details->description}}</h4>
                <br>
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => $market_details->id , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))}}" method = "POST">
