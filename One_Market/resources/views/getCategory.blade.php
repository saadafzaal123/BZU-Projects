    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <h3>{{$g->name}}</h3>
                <img src="/One_Market/public/product_images/{{$g->image1}}" height = "350" width = "350" alt="{{$g->image1}}">
                <h3>{{"Price: $ ".$g->price}}</h3>
                <br>
                <a href = "{{ URL::route('getProductDetails', array('id' => $g->id , 'v_id' => $g->vendor_id)) }}"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "{{ URL::route('addToCart', array('p_id' => $g->id , 'price' => $g->price , 'shop_id' => 0 , 'category_id' => $cats->id , 'vendor_id' => $shop->id , 'brand_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0)) }}"><button type="button" class="btn btn-primary btn-md">Add to Cart</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => $cats->id , 'vendor_id' => $shop->id , 'brand_id' => 0))}}" method = "POST">
