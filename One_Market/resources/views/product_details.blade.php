       ...
       <header>               
        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    <form action = "{{route('searchProduct' ,  array('v_id'=>$shop_details->id))}}" method = "POST">

                        <input type = "hidden" name ="_token" value = "{{csrf_token()}}">

                        <input type = "text" id = "search" name = "product" placeholder = "Search a Product" required = "required"/>
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
					    ...
					    <li><a href="#services"><span class="btnicon icon-user"></span>Product Details</a></li>
                        ...
                        <li class="active"><a href="/One_Market/public/Customer_Login"><span class="btnicon icon-cloud-download"></span>@if (Session::get('c_email') != null) {{$customer->username}} @else Customer Log In @endif</a></li>
						<li class="active"><a href="/One_Market/public/Vendor_Login"><span class="btnicon icon-cloud-download"></span>@if (Session::get('email') != null) {{$vendor->username}} @else Vendor Log In @endif</a></li>
                    </ul>
	  ...
	  <!-- ==============================
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    <a href="{{URL::route('getItems', array('id' => $shop_details->id))}}" id="" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-dashboard fa-stack-1x "></i></span>{{$shop_details->shop_name}}</a>
                </li>


                <li class="active">

                    <a href="#" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> Categories </a>

                    @foreach($cat as $c)

                        <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                            <li style = "font-size: 18px;"><a href="{{URL::route('getCategory', array('c_id' => $c->id , 'v_id' => $shop_details->id))}}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$c->name}} </a></li>
                        </ul>
                ...
                <li class="active">
                    ...
                    <a href="#" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> Brands </a>

                    @foreach($brand as $b)

                        <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                            <li style = "font-size: 18px;"><a href="{{URL::route('getBrand', array('b_id' => $b->id , 'v_id' => $shop_details->id))}}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$b->name}} </a></li>
                        </ul>
                ...
                @foreach($city as $c)
                    ...
                    <li>
                        ...
                        <a href="{{ URL::route('getMarkets', array('id' => $c->id))  }}" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$c->name}} </a>
                    </li>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                <h2 style = "margin-bottom: 20px;">{{$product_details->name}}</h2>
                <img src="/One_Market/public/product_images/{{$product_details->image1}}" height = "350" width = "350" alt="{{$product_details->image1}}">
                <img src="/One_Market/public/product_images/{{$product_details->image2}}" height = "350" width = "350" alt="{{$product_details->image1}}">
                <img src="/One_Market/public/product_images/{{$product_details->image3}}" height = "350" width = "350" alt="{{$product_details->image1}}">
                <h3>{{"Price: $ ".$product_details->price}}</h3>
                <br>
                <h4>{{$product_details->description}}</h4>
                <br>
                <a href = "{{URL::route('getItems', array('id' => $shop_details->id))}}"><button type="button" class="btn btn-primary btn-md" style = "width: auto; float: start; margin-right: 40px;">Go Back</button></a>
                <a href = "{{ URL::route('addToCart', array('p_id' => $product_details->id , 'price' => $product_details->price , 'shop_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0 , 'product_details_id' => $product_details->id , 'shop_details_id' => $shop_details->id)) }}"><button type="button" class="btn btn-primary btn-md" style = "width: auto; float: end; margin-left: 40px;">Add to Cart</button></a>
            </div> <!-- ITEM END -->
                   ...
                   <div  class="col-md-6 col-lg-12 wow fadeInUp" data-wow-duration="3s">
                       ...
                       <div class="container">
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => $product_details->id , 'shop_details_id' => $shop_details->id , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))}}" method = "POST">
                                                       ...
                                                       <td><b style = "margin-left: -170px;">{{$p->name}}</b><br> <img src="/One_Market/public/product_images/{{$p->image1}}" width = "60" height = "60" alt="{{$p->name}}" style="text-align: center;  margin-left: -170px;"></td>
                                                       <td><input type="number" max="100" min="0" size="6"  name = "quantity" value = "{{$c->quantity}}" style = "margin-left: -160px;"/> </td>
                                                       <td><p style = "margin-left: -185px; color: black;">{{'$'.$p->price * $c->quantity}}</p></td>
                           ...
                           <div style = "font-size: 22px;" class="col-md-6 col-lg-9 wow fadeInUp" data-wow-duration="3s">
                               <b style = "float: right; margin-right: -168px;">@if (Session::get('c_email') != null) {{'$'.$total}} @endif </b>
                           ...
                           <div style = "font-size: 22px;" class="col-md-6 col-lg-9 wow fadeInUp" data-wow-duration="3s">
                               ...
                               @if (Session::get('c_email') != null)
                                   ...
                                   <a href = "{{ URL::route('customerCheckOut' , array('id' => $customer->id))}}"><button style = "width: 15%; margin-right: -60px; float: right;" type="button" class="btn btn-primary btn-md">Checkout</button></a>

                               @else

                                   <a href = "{{ URL::route('Customer_Login')}}"><button style = "width: 15%; margin-right: -60px; float: right;" type="button" class="btn btn-primary btn-md">Checkout</button></a>
