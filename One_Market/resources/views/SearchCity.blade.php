    ...
    <div id="services" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="/One_Market/public/city_images/{{$s->image1}}" height = "400" width = "400" alt="{{$s->image1}}">
                <h3>{{$s->name}}</h3>
                <a href="{{ URL::route('getCityDetails', array('id' => $s->id)) }}"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href="{{ URL::route('getMarkets', array('id' => $s->id)) }}"><button type="button" class="btn btn-primary btn-md">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
