        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    ...
                    <form action = "{{route('searchMarket' , array('c_id'=>$getCity->id))}}" method = "POST">
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
					    ...
					    <li><a href="#services"><span class="btnicon icon-user"></span>Markets</a></li>
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li>
                    ...
                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                        <li class = "active"><a href="{{ URL::route('getShops', array('id' => $s->id)) }}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$s->name}} </a></li>
                    </ul>

                </li>

                           @elseif($s->city_id != $c->id)
    ...
    <div id="services" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="/One_Market/public/market_images/{{$s->image1}}" height = "400" width = "400" alt="{{$s->image1}}">
                <h3>{{$s->name}}</h3>
                <br>
                <a href = "{{ URL::route('getMarketDetails', array('id' => $s->id)) }}"><button type="button" class="btn btn-primary btn-md">Details</button></a>
               <a href = "{{ URL::route('getShops', array('id' => $s->id)) }}"><button type="button" class="btn btn-primary btn-md">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
