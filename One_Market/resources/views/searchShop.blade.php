       ...
       <header>               
        ...
        <div id="hero">           
			...
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
                    <form action = "{{route('searchShop' , array('m_id'=>$getMarket->id))}}" method = "POST">

                        <input type = "hidden" name ="_token" value = "{{csrf_token()}}">

                        <input type = "text" id = "search" name = "shop" placeholder = "Search a Shop" required = "required"/>
               ...
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
					    ...
					    <li><a href="#services"><span class="btnicon icon-user"></span>Shops</a></li>
                    ...
                    @foreach($search as $s)
                        ...
                        @if($s->market_id == $m->id)
                            ...
                            <li>
                                ...
                                <a href="{{ URL::route('getShops', array('id' => $m->id)) }}" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$m->name}} </a>

                                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                                        <li class="active"><a href="{{URL::route('getItems', array('id' => $s->id))}}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span> {{$s->shop_name}} </a></li>
                                    </ul>
    ...
    <div id="services" class="container">
        ...
        <div class="row" id = "D_Button">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="/One_Market/public/shop_images/{{$s->shop_image}}" height = "400" width = "400" alt="{{$s->shop_image}}">
                <h3>{{$s->shop_name}}</h3><br>
                <a href = "{{URL::route('getItems', array('id' => $s->id))}}"><button type="button" class="btn btn-primary btn-md" style = "margin-left:15px;">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
                                       ...
                                       @foreach($product as $p)
                                           ...
                                           @if($c->p_id == $p->id)
                                               ...
                                               <tr>
                                                   ...
                                                   <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => $getMarket->id , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))}}" method = "POST">
