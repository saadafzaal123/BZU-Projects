...
<!--<<<<<<< HEAD-->
			<div id = "searching" style = "margin-top:60px; margin-bottom:100px;">
                <div id = "B_Hover">
	            <form action = "{{route('searchCity')}}" method = "POST">
<!--=======
            ...
            <li class="active"><a href="Customer_Login"><span class="btnicon icon-cloud-download"></span>Customer Log In</a></li>
			<li class="active"><a href="Vendor_Login"><span class="btnicon icon-cloud-download"></span>Vender Log In</a></li>
        </ul>
		
    </div><!--.nav-collapse -->
<!--gg>>>>>>> 5beaaef3e152d4bdd643dc5ca0b457ad12ee92cc-->

                    <input type = "hidden" name ="_token" value = "{{csrf_token()}}">

	                <input type = "text" id = "search" name = "city" placeholder = "Search a City" required = "required"/>
          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
               <div class="container">
                ...
                <div class="collapse navbar-collapse">
					...
					<li><a href="#services"><span class="btnicon icon-user"></span>Cities</a></li>
                        <li><a href="#about"><span class="btnicon icon-user"></span>About us</a></li>
						...
						<li class="active"><a href="Vendor_Login"><span class="btnicon icon-cloud-download"></span>@if (Session::get('email') != null) {{$vendor->username}} @else Vendor Log In @endif</a></li>
                    </ul>
	  ...
	  <!-- ==============================
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <li  class="active">
                    <a href="#" id="" class="shop"><span class="fa-stack fa-lg pull-left"><i class="fa fa-dashboard fa-stack-1x "></i></span> Major Cities</a>
    ...
    <div id="services" class="container">
        ...
        <div class="sectionhead  row wow fadeInUp">
            <img data-wow-duration="4s" src="img/select.png" height = "150px" alt="Search Logo"/>  
            <h3>Select Cities Here</h3>
            <hr class="separetor">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-duration="3s">
                <img src="city_images/{{$c->image1}}" height = "400" width = "400" alt="">
                <h3>{{$c->name." City"}}</h3>
                <br>
                <a href = "{{ URL::route('getCityDetails', array('id' => $c->id)) }}"><button type="button" class="btn btn-primary btn-md">Details</button></a>
                <a href = "{{ URL::route('getMarkets', array('id' => $c->id)) }}"><button type="button" class="btn btn-primary btn-md">GoInside</button></a>
                <hr class="separetor">
            </div> <!-- ITEM END -->
   ...
   =========================== -->
           <div id="portfolio" class="container" style = "background: white; margin-bottom: -50px;">
               ...
               <div class="sectionhead  row wow fadeInUp" style = "margin-top: -40px;">
                   <img data-wow-duration="4s" src="img/add.png" height = "120px" alt="Search Logo"/>
                   <h3>Shopping Cart</h3>
                   <hr class="separetor">
               </div><!--Cities SECTION HEADING END-->
                                           ...
                                           @foreach($product as $p)
                                               ...
                                               @if($c->p_id == $p->id)
                                                   ...
                                                   <tr>
                                                       ...
                                                       <form action = "{{route('updateCart', array('id' => $c->id , 'shop_id' => 0 , 'city_id' => 0 , 'market_id' => 0 , 'city_details_id' => 0 , 'market_details_id' => 0 , 'product_details_id' => 0 , 'shop_details_id' => 0 , 'category_id' => 0 , 'vendor_id' => 0 , 'brand_id' => 0))}}" method = "POST">
    ...
    <div id="testimonials" class="container">
        ...
        <div class="row" style = "margin-left: 40px;">
            ...
            <div class="col-md-9 wow bounceIn" data-wow-duration="3s">
                <div class="clientsphoto">
                    <img src="img/zawar.jpg" alt="Bill">
                </div>
            ...
            <div class="col-md-9 wow bounceIn" data-wow-duration="3s">
                <div class="clientsphoto">
                    <img src="img/halif.jpg" alt="Eric">
                </div>
            ...
            <div class="col-md-9 wow bounceIn" data-wow-duration="2s">
                <div class="clientsphoto">
                    <img src="img/bilal.jpg" alt="Ramil">
                </div>
