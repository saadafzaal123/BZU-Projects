...
<h1>Manage Your Content</h1>
  ...
  <form action = "insert_new_brand.php" method = "POST">
   <table width = "700" align = "left" border = "1" bgcolor="white">
	  ...
	  <tr>
	    <td colspan = "2" align = "center" height = "30"><input type = "submit" name = "insert_brand" value = "Insert Brand" style = "margin-top:6px"/></td>
	  </tr>
    ...
    <div id = "right_content">
	   ...
	   <div id = "navbar">
				...
				<ul id = "menu">
			    	...
			    	<li><a href = "insert_new_brand.php" class = "selected">Insert New Brand</a></li>
...
if(isset($_POST['insert_brand']))
{
   ...
   if(!empty($brand))
   {
	  ...
	  if($run_query)
	  {
	     echo "<script>alert('Brand Insert Successfully...')</script>";
	  }
   }
   else
   {
