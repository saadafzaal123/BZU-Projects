		  ...
		  <!-- Navigation Bar Starts -->
		    <div id = "navbar">
				...
				<ul id = "menu">
			    	...
			    	<li><a href = "cart.php" class = "selected">Shopping Cart</a></li>
				...
				<?php cart(); ?>
				   ...
				   <div id = "headline">
				      ...
				      <div id = "headline_content">
						 ...
						 "index.php" style = "color:gold">Back to Shop</a></span>
				   ...
				   <div id = "products_box">
				     ...
				     <form action = "" method = "POST" enctype = "multipart/form-data">
				      <table align = "center" bgcolor = "#396" width = "730" style = "margin-top:-20px; margin-bottom:-5px;" >
					    <tr align = "center">
						   <th>Update</th>
						   <th>Remove</th>
						   <th>Product (s)</th>
						...
						<tr align = "center">
						<td colspan = "3"><input type = "submit" name = "continue" value = "Continue Shopping"></td>
						<td colspan = "2"><button><a href = "checkout.php" style = "text-decoration:none; color:#000000;">Checkout</a></button></td>
						</tr>
